<?php
	...
	$db_name = 'asopamo'; //Nombre de la Base de datos
	...
	$dump = "C:\wamp64\bin\mariadb\mariadb10.4.10\bin\mysqldump --user =".$db_user." --password = ".$db_pass." --host =".$db_host." ".$db_name."> $salida_sql";
